            ...
            te.prototype = {
                    ...
                    function W(e, t) {
                        ...
                        if (void 0 === l && (l = 0),
                            ...
                            if (c = N.selectpicker.view.visibleElements ? N.selectpicker.view.visibleElements.slice() : [],
                                ...
                                if (N.options.sanitize && k.length && P(k, N.options.whiteList, N.options.sanitizeFn), !0 === u ? (v = 0 === N.selectpicker.view.position0 ? 0 : N.selectpicker.current.data[N.selectpicker.view.position0 - 1].position,
                ...
                setPlaceholder: function() {
                    ...
                    if ((this.options.placeholder || this.options.allowClear) && !this.multiple) {
                        ...
                        n && (this.selectpicker.view.titleOption.className = "bs-title-option",
                                ...
                                s = !l || o === a && !1 === l.defaultSelected && void 0 === this.$element.data("selected")), !n && 0 === this.selectpicker.view.titleOption.index || i.insertBefore(this.selectpicker.view.titleOption, i.firstChild),
                ...
                setMenuSize: function(e) {
                    ...
                    if (this.options.dropupAuto && (r = d * this.selectpicker.current.data.length + v.vert,
                            a = this.sizeInfo.selectOffsetTop - this.sizeInfo.selectOffsetBot > this.sizeInfo.menuExtras.vert && r + this.sizeInfo.menuExtras.vert + 50 > this.sizeInfo.selectOffsetBot, !0 === this.selectpicker.isSearching && (a = this.selectpicker.dropup),
                        ...
                        this.$menuInner.on("click", "li a", function(e, t) {
                            ...
                            if (O.multiple && 1 !== O.options.maxOptions && e.stopPropagation(),
                                ...
                                if (l === O.activeIndex && (t = !0),
                                    ...
                                    d && O.setSelected(d, !1),
                                    O.setSelected(o, !0);
                                O.options.source.data && O.$element[0].appendChild(O.selectpicker.main.optionQueue), !O.multiple || O.multiple && 1 === O.options.maxOptions ? O.$button.trigger("focus") : O.options.liveSearch && O.$searchbox.trigger("focus"),
                ...
                toggle: function(e, t) {
                    var i, s = void 0 === t;
                    (e = e || window.event) && e.stopPropagation(), !1 === s && (i = this.$newElement[0].classList.contains(G.SHOW),
                            s = !0 === t && !1 === i || !1 === t && !0 === i),
                            ...
                            if (e.which === N && i && (e.preventDefault(),
                                ...
                                if (b.length) {
                                    ...
                                    c.removeClass("active").find("a").removeClass("active"),
                                        ...
                                        v = b[x],
                                        d = 0 < u - (n = a.selectpicker.main.data[v]).position ? (o = n.position - n.height, !0) : (o = n.position - a.sizeInfo.menuInnerHeight,
